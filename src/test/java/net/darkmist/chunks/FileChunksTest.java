...
public class FileChunksTest
{
	...
	{
		private static final Method implCloseChannelMeth = getImplCloseChannelMeth();
		private final FileChannel target;

		private static Method getImplCloseChannelMeth()
		{
			Method meth;

			try
			{
				meth = FileChannel.class.getMethod("implCloseChannel");
				meth.setAccessible(true);
			}
			catch(NoSuchMethodException e)
			{
				throw new IllegalStateException("Unable to get method implCloseChannel from FileChannel class.", e);
			}
			return meth;
		}
	...
	private static class TestingFileChannel extends FileChannel
	{
		@Override
		public int read(ByteBuffer buf) throws IOException
		{
	...
	@ParameterizedTest
	@MethodSource("streamSmallSizes")
	public void testSlurpOff1enNeg2(long size) throws IOException
	{
		Chunk chunk;
		Path path;
	...
	@ParameterizedTest
	@MethodSource("streamSmallSizes")
	public void testMapOff1enNeg2(long size) throws IOException
	{
		Chunk chunk;
		Path path;
